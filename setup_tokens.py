...
TOKENS = [
    ("OKTA_ADMIN_DEV_API_TOKEN",  "DEV  (https://host.example.gov)"),
    ("OKTA_ADMIN_STG_API_TOKEN",  "STG  (https://host.example.gov)"),
    ("OKTA_ADMIN_PROD_API_TOKEN", "PROD (https://host.example.gov)"),
]
